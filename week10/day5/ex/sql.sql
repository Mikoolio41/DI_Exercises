...
SELECT CONCAT(first_name, ' ', last_name) AS "Fullname", LENGTH (CONCAT(first_name, ' ', last_name)) AS "Fullname Length" FROM employees;
...
-- Write a query to display the last_name, job, and salary of all the employees who don’t work as Programmers or
--  Shipping Clerks, and who don’t receive a salary equal to $4,500, $10,000, or $15,000.
SELECT last_name, salary, job_title FROM employees e INNER JOIN jobs j ON e.job_id = j.job_id 
